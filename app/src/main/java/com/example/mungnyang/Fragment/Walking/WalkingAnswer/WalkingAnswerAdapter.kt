...
class WalkingAnswerAdapter(private val context: Context?, private val walkingAnswerList: MutableList<WalkingAnswer>, private val boardEmail: String) : RecyclerView.Adapter<WalkingAnswerAdapter.AnswerWalkingViewHolder>() {
                    ...
                    if (responseDto != null) {
                        ...
                        if (answerList.isNotEmpty()) {
                            ...
                            for (answerList in answerList) {
                                ...
                                Log.d("ㅌㅌㅌㅌ11111", answerText)
                                Log.d("ㅌㅌㅌㅌ222222", answerTextToDB)
                                Log.d("ㅌㅌㅌㅌ333333", answerEmail)
                                Log.d("ㅌㅌㅌㅌ444444", answerEmail2)
                                Log.d("ㅌㅌㅌㅌ555555", petName)
                                Log.d("ㅌㅌㅌㅌ666666", boardPetNameToDB)
