...
class DiaryAnswerFriendAdapter(
    private val context: Context?,
    private val diaryAnswerList: MutableList<DiaryAnswer>,
    private val userEmail: String
) : RecyclerView.Adapter<DiaryAnswerFriendAdapter.AnswerDiaryFriendViewHolder>() {
        ...
        RecyclerView.ViewHolder(binding.root)
    {
        ...
        fun bind(
            ...
            diaryAnswerFriendAdapter: DiaryAnswerFriendAdapter,
            userEmail: String
        ){
            ...
            if(userEmail == answerEmail) {
                searchByUserEmail(userEmail) { answerIDToDB ->
                    ...
                    binding.deleteAnswerBtn.setOnClickListener {
                        ...
                        if (position != RecyclerView.NO_POSITION) {
                            ...
                            diaryAnswerFriendAdapter.deleteItem(position) // 리사이클러뷰에서 해당 항목 삭제
                        }
                    }
                }
            }
        ...
        private fun searchByUserEmail(userEmail1: String, onSearchComplete: (answerID: String) -> Unit){

            val sendDiaryAnswerSearch = retrofit.apiService.searchByUserEmail(userEmail1)
